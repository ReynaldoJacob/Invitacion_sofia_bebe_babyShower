<template>
    <div class="rsvp-root">
        ...
        <nav class="fixed bottom-0 left-0 w-full md:hidden z-50 flex justify-around items-center px-4 pb-4 pt-2"
            ...
            <RouterLink :to="linkId ? { path: '/lugar', query: { link_id: linkId } } : '/lugar'" class="flex flex-col items-center justify-center gap-1 py-1 px-3 rounded-full transition-all"
               style="color:#4d4635;">
