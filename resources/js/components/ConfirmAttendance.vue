<template>
    <div class="rsvp-root">
                ...
                <div class="w-full max-w-sm rounded-3xl overflow-hidden relative"
                    ...
                    <div class="p-8 text-center">
                        ...
                        <div v-if="form.attendance === 'yes'"
                            ...
                            <p style="font-family:'Itim',cursive; font-size:14px; color:#4d4635;">🕐 Llegar puntual — 1:00 pm</p>
        ...
        <nav class="fixed bottom-0 left-0 w-full md:hidden z-50 flex justify-around items-center px-4 pb-4 pt-2"
            ...
            <RouterLink to="/lugar" class="flex flex-col items-center justify-center gap-1 py-1 px-3 rounded-full transition-all"
               style="color:#4d4635;">
